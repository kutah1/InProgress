...
const Navbar = () => {
  ...
  return (
    <nav className="flex plus-jakarta-sans flex-col md:flex-row items-center justify-between text-white p-4 w-full gap-4 md:gap-0" style={{backgroundColor:'#0F172A'}} aria-label="Main Navigation">
      ...
      <ul className={`flex-col items-center flex text-center gap-2 w-full md:flex md:flex-row md:items-center md:gap-4 md:w-auto ${menuOpen ? 'flex' : 'hidden'} md:!flex`}>
        ...
        <li>
          <div className="flex flex-col gap-2 w-full md:flex-row md:gap-2 md:w-auto md:mt-0 justify-center md:justify-end mt-2 ">
            <Link to="/login">
