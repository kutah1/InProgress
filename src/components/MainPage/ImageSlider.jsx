...
const cards = [
  ...
  },
  {
    ...
    subtitle: 'UI/UX gig',
    description: 'Get a detailed UX audit of your product with actionable insights to increase conversion and user satisfaction.',
    host: 'Olivia Rhye',
    rating: 4.8,
    button: 'Order',
  },
  {
    ...
    description: 'High-converting landing page copy tailored to your target audience for better lead generation.',
    host: 'Olivia Rhye',
    rating: 5.0,
    button: 'Order',
  },
            ...
            <div className="p-5 flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3 mt-3">
                <div className="w-10 h-10 rounded-full bg-[#C7B9DA] flex items-center justify-center">
                  <img src={Olivia} alt={card.host} className="w-10 h-10 rounded-full" />
                </div>
                <div>
                  <h3 className="text-[#0F172A] font-semibold">{card.host}</h3>
  ...
  return (
    <>
      <div className="ml-30 mt-10">
        <h1 className="font-semibold text-5xl">Popular Gigs Near Kumasi</h1>
        <p className="mt-3">
      ...
      <section
        className="md:flex justify-center items-center mt-10 min-h-[500px] hidden"
        aria-label="Image Slider"
      >
        <div className="relative flex w-full max-w-6xl justify-center items-center">
          <AnimatePresence>{sliderCards}</AnimatePresence>
        </div>
      </section>
    </>
  );
