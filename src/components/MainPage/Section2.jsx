...
const Section2 = memo(() => {
  ...
  return (
    ...
    <div className='flex flex-col plus-jakarta-sans justify-center items-center text-[#0F172A] p-2 sm:p-4 md:p-8'>
          <h1 className='text-[#FF790C]  items-start  text-left mr-10 transform md:-translate-x-55 text-2xl sm:text-3xl md:text-4xl font-semibold  sm:ml-5 my-6 sm:my-10 '>Why Students Use GigUpp</h1>
